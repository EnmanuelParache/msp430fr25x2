...
pub mod adc;
#[doc = "CAPTIVATE"]
pub type Captivate = crate::Periph<captivate::RegisterBlock, 0x0b20>;
impl core::fmt::Debug for Captivate {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Captivate").finish()
    }
}
#[doc = "CAPTIVATE"]
pub mod captivate;
